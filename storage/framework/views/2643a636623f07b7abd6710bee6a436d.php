...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a class="text-sm font-semibold text-blue-600 hover:underline" href="<?php echo e(route('password.request')); ?>">
                            Forgot Password?
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="text-center">
                ...
                <a href="<?php echo e(route('register')); ?>" class="w-full inline-flex items-center justify-center gap-2 border-2 border-emerald-500 hover:bg-emerald-50 text-emerald-600 font-bold py-3 px-4 rounded-lg transition-colors tracking-wide">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
