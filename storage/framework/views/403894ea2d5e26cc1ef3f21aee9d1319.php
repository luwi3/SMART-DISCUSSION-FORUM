...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="menu-item <?php echo e(request()->is('dashboard') || request()->is('lecturer/dashboard') || request()->is('/') ? 'active' : ''); ?>">
            ...
            <li class="menu-item <?php echo e(request()->is('chat*') || request()->is('discussion*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('chat.index')); ?>">Manage Discussion</a>
            </li>
            
            <li class="menu-item <?php echo e(request()->is('participation*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('participation.index')); ?>">Participation Marks</a>
            </li>
            
            <li class="menu-item <?php echo e(request()->is('resources*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('resources.index')); ?>">Upload Resources</a>
            </li>
        </ul>
