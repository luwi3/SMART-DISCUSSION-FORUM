        ...
        <main class="main-content">
            ...
            <section class="cards-row">
                <div class="metric-card">
                    ...
                    <div class="m-val">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($maxPossibleMarks > 0): ?>
                            <?php echo e($totalParticipationScore); ?> <span style="font-size: 16px; color: #64748b; font-weight: 500;">/ <?php echo e($maxPossibleMarks); ?></span>
                        <?php else: ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($activeQuizzes) && count($activeQuizzes) > 0): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeQuizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activeQuiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="list-row-item">
                                        ...
                                        <a href="<?php echo e(route('quizzes.show', ['quizID' => $activeQuiz->quizID ?? $activeQuiz->id])); ?>" style="display: inline-block; padding: 8px 16px; background: #10b981; color: white; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 13px;">✍️ Attempt Quiz</a>
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <?php else: ?>
            ...
            <div id="profile-view" class="dashboard-screen">
                ...
                <div class="placeholder-card" style="max-width: 100%;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid #e2e8f0; padding-bottom: 10px;">
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" style="padding: 6px 14px; background: #2563eb; color: white; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: 700;">⚙️ Edit Profile</a>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 20px; margin-bottom: 30px;">
                        <div>
                            ...
                            <div style="font-size: 15px; font-weight: 600; color: #0f172a;"><?php echo e(Auth::user()->name); ?></div>
                        </div>
                        <div>
                            ...
                            <div style="font-size: 15px; font-weight: 600; color: #0f172a;"><?php echo e(Auth::user()->email); ?></div>
                        </div>
                        <div>
                            ...
                            <div style="font-size: 15px; font-weight: 600; color: #0f172a;"><?php echo e(Auth::user()->username ?? 'N/A'); ?></div>
                        </div>
                        <div>
                            ...
                            <div style="font-size: 15px; font-weight: 600; color: #0f172a;"><?php echo e(Auth::user()->phone ?? 'No Phone Number'); ?></div>
                        </div>
                    </div>
