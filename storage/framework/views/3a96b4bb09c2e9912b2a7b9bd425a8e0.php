...
<head>
    ...
    <title><?php echo e($quiz->title); ?></title>
    <style>
...
<div class="quiz-container">
    ...
    <div class="meta-grid">
        <div class="meta-item">
            ...
            <input type="text" value="<?php echo e($quiz->quizID ?? $quiz->id); ?>">
        </div>
        <div class="meta-item">
            <label>Course Code</label>
            <input type="text" value="<?php echo e($quiz->courseCode); ?>">
        </div>
        <div class="meta-item">
            <label>Start Time</label>
            <input type="text" value="<?php echo e(\Carbon\Carbon::parse($quiz->startTime)->format('h:i A')); ?>">
        </div>
        <div class="meta-item">
            <label>Duration</label>
            <input type="text" value="<?php echo e($quiz->duration); ?> min">
        </div>
    </div>
    ...
    <form id="quizForm" method="POST" action="/quizzes/<?php echo e($quiz->quizID ?? $quiz->id); ?>/submit">
        <?php echo csrf_field(); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="question-block">
                <p class="question-title"><strong>Q<?php echo e($index + 1); ?>.</strong> <?php echo e($question->question_text); ?></p>
                
                <div class="options-list">
                    <label class="option-item">
                        <input type="radio" name="answers[<?php echo e($question->id); ?>]" value="A" required>
                        <span>A. <?php echo e($question->option_a); ?></span>
                    </label>
                    <label class="option-item">
                        <input type="radio" name="answers[<?php echo e($question->id); ?>]" value="B">
                        <span>B. <?php echo e($question->option_b); ?></span>
                    </label>
                    <label class="option-item">
                        <input type="radio" name="answers[<?php echo e($question->id); ?>]" value="C">
                        <span>C. <?php echo e($question->option_c); ?></span>
                    </label>
                    <label class="option-item">
                        <input type="radio" name="answers[<?php echo e($question->id); ?>]" value="D">
                        <span>D. <?php echo e($question->option_d); ?></span>
                    </label>
                </div>
            </div>
...
<script>
    let totalSeconds = parseInt("<?php echo e($remainingSeconds ?? -1); ?>");

    if (totalSeconds === -1) {
        const startTime = new Date("<?php echo e(\Carbon\Carbon::parse($quiz->startTime)->toIso8601String()); ?>").getTime();
        const durationMinutes = <?php echo e($quiz->duration); ?>;
...
</html><?php /**PATH C:\xampp\xam\htdocs\smart-discussion-forum\resources\views/quizzes/show.blade.php ENDPATH**/ ?>