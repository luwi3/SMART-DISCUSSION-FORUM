...
<script type="module">
    ...
    // ===============================
    // Message cache — lets us show real "replying to" text
    // for messages appended live via JS, not just server-rendered ones.
    // ===============================
    const messageCache = {};
    ...
    // Delegate reply-trigger clicks (works for both server-rendered and JS-appended messages)
    ...
    // ===============================
    // Append a message (own optimistic send, or incoming from Echo)
    // replyTo (if provided) = { id, sender, body }
    // ===============================
    ...
    if (chatForm) {
        chatForm.addEventListener('submit', function (e) {
            ...
            // Optimistic render — uses a temporary DOM row with no real id yet.
